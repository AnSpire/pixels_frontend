...
const RTXInfo = () => {
  ...
  return (
    <div>
      <div className="max-w-[1150px] md:min-h-[1085px] bg-neutral-900 rounded-3xl px-[1.5rem] md:px-[4.5rem] pt-[2.5rem] md:pt-[6rem] pb-[5rem] mb-[7.12rem] flex flex-col justify-center items-center">
        <div className="text-center w-full h-[9rem] md:h-auto md:w-full rtx_gradient text-amber-50 text-[2rem] md:text-[64px] font-bold font-['SF Pro Display'] leading-[2.25rem] md:leading-[68px] mb-[5rem] font-bold">
          Искусство <br className="md:hidden"/> в каждом пикселе,

          продвинутая графика с Nvidia
        </div>
